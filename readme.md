...
<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fcougarx14%2Fsimple-openvpn-server%2FfeatureUpdate%2Fopenvpn-template.json" target="_blank"><img src="http://azuredeploy.net/deploybutton.png"/></a>
...
1. Download the installer script.
	...
	````
	wget https://raw.githubusercontent.com/cougarx14/simple-openvpn-server/master/openvpn.sh
	````
